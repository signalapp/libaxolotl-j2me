...
public class GroupCipherTest extends TestCase {
      ...
      throws LegacyMessageException, DuplicateMessageException, InvalidMessageException, NoSessionException
  {
    ...
    GroupCipher aliceGroupCipher = new GroupCipher(new FakeSecureRandomProvider(), aliceStore, "groupWithBobInIt");
    GroupCipher bobGroupCipher   = new GroupCipher(new FakeSecureRandomProvider(), bobStore, "groupWithBobInIt::aliceUserName");

    byte[]    aliceSenderKey        = KeyHelper.generateSenderKey(new FakeSecureRandomProvider());
    ECKeyPair aliceSenderSigningKey = KeyHelper.generateSenderSigningKey(new FakeSecureRandomProvider());
    int       aliceSenderKeyId      = KeyHelper.generateSenderKeyId(new FakeSecureRandomProvider());
