...
public class ChainKeyTest extends TestCase {
  ...
  public void testChainKeyDerivationV2() {
    ...
    assertTrue(Arrays.equals(chainKey.getMessageKeys().getCipherKey().getKey(), messageKey));
    assertTrue(Arrays.equals(chainKey.getMessageKeys().getMacKey().getKey(), macKey));
