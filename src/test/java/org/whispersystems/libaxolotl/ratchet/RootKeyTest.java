...
public class RootKeyTest extends AxolotlBaseTestCase {
  ...
  public void testRootKeyDerivationV2() throws InvalidKeyException {
    ...
    Pair rootKeyChainKeyPair = rootKey.createChain(bobPublicKey, aliceKeyPair);
    RootKey                 nextRootKey         = (RootKey)rootKeyChainKeyPair.first();
    ChainKey                nextChainKey        = (ChainKey)rootKeyChainKeyPair.second();
